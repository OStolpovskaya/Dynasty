...
public class Adventure {
    ...
    @Size(min = 50, max = 1600, message = "{adventure.creation.textDescSize}")
    private String textDesc;

    @Size(min = 50, max = 1000, message = "{adventure.creation.textSuccessSize}")
    private String textSuccess;

    @Size(min = 50, max = 800, message = "{adventure.creation.textFailedSize}")
