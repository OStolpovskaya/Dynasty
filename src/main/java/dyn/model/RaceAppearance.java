...
public class RaceAppearance {
    ...
    public String toString() {
        ...
        sb.append(", body=").append(body == null ? "null" : body.getTitle());
        sb.append(", ears=").append(ears == null ? "null" : ears.getTitle());
        sb.append(", eyebrows=").append(eyebrows == null ? "null" : eyebrows.getTitle());
        sb.append(", eyeColor=").append(eyeColor == null ? "null" : eyeColor.getTitle());
        sb.append(", eyes=").append(eyes == null ? "null" : eyes.getTitle());
        sb.append(", hairColor=").append(hairColor == null ? "null" : hairColor.getTitle());
        sb.append(", hairType=").append(hairType == null ? "null" : hairType.getTitle());
        sb.append(", head=").append(head == null ? "null" : head.getTitle());
        sb.append(", height=").append(height == null ? "null" : height.getTitle());
        sb.append(", mouth=").append(mouth == null ? "null" : mouth.getTitle());
        sb.append(", nose=").append(nose == null ? "null" : nose.getTitle());
        sb.append(", skinColor=").append(skinColor == null ? "null" : skinColor.getTitle());
        sb.append('}');
        return sb.toString();
    }
}
